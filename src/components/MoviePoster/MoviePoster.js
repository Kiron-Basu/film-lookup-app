...
const MoviePoster = (props) => {
    ...
    if (props.movie.Title.length > 30){ //truncates long titles
         title =  props.movie.Title.substring(0, 27) + '...';} else {
    ...
    return (
        <div className={classes.MoviePoster}>
           ...
           <div>
            ...
            <button className={classes.MoviePoster} onClick={()=> props.relatedMovies(props.movie.Title)}>Info</button>
        </div>
    )
}
